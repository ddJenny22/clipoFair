...
const Dashboard = () => {
  const { visitors, promotionalMaterials, souvenirs, coupons } =
      ...
      <div className="col-span-1 bg-gray-100 p-6 rounded-lg">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div
              className={`p-6 rounded-lg ${
                promotionalMaterials.pamphlets <= 100
            ...
            <div
              className={`p-6 rounded-lg ${
                promotionalMaterials.flyers <= 100
                  ? "border-3 border-red-500"
                  : "bg-gray-100"
              }`}
              style={
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div
              className={`p-6 rounded-lg ${
                souvenirs <= 100 ? "border-3 border-red-500" : "bg-gray-100"
              }`}
            ...
            >
              ...
              <p
                className={`text-4xl font-bold ${
                  souvenirs <= 100 ? "text-red-900" : "text-brown"
                }`}
              >
                {souvenirs} 개
              </p>
            ...
            <div
              className={`p-6 rounded-lg ${
                coupons <= 100 ? "border-6 border-red-500" : "bg-gray-100"
              }`}
            ...
            >
              ...
              <p
                className={`text-4xl font-bold ${
                  coupons <= 100 ? "text-red-900" : "text-navy"
                }`}
              >
                {coupons} 개
              </p>
